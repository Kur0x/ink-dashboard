"""
MicroPython Waveshare 7.5" Black/White/Red GDEW0583Z21 e-paper display driver
...
class EPD:
    ...
    def display_frame(self, frame_buffer_black, frame_buffer_red): # 0 for set
        if (frame_buffer_black != None and frame_buffer_red != None):
